...
printf "${BOLD}${YELLOW}##########################################################\n"
printf "##### Welcome to the BITEX RECON dependency installer #####\n"
printf "##########################################################\n\n${NORMAL}"
...
# Create BITEX RECON directory if it doesn't exist
...
cd .. || echo "Failed to return to BITEX RECON directory"
